...
export const env = {
  ...
  TWEETS_COLLECTION: process.env.TWEETS_COLLECTION,
  HASHTAGS_COLLECTION: process.env.HASHTAGS_COLLECTION,
  BOOKMARKS_COLLECTION: process.env.BOOKMARKS_COLLECTION,
